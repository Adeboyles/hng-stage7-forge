# Artifact Registry + Dependency Resolver Implementation

Contained in this file, is the documentation of the core artifact registry and dependency resolver logic implementation for Forge.

The task is focused on three registry modules:
